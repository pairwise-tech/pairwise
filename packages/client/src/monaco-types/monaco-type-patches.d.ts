...
// These are mainly copied from the TS lib but without the line to exclude the
// rest of the lib.d.ts.
...
interface PromiseConstructor {
  ...
  allSettled<T>(
    ...
    Array<PromiseSettledResult<T extends PromiseLike<infer U> ? U : T>>
  >;
}
