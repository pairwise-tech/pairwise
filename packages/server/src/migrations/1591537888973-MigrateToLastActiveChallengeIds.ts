...
export class MigrateToLastActiveChallengeIds1591537888973 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "lastActiveChallengeIds" jsonb NOT NULL DEFAULT '"{}"'`);
    }
