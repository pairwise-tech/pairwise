  ...
  <Layout>
    ...
    <Section>
      <ConstrainWidth>
        ...
        <ol type="a">
          <li>
            The materials on Pairwise, LLC's website are provided on an 'as is'
            basis. Pairwise, LLC makes no warranties, expressed or implied, and
          ...
          <li>
            Further, Pairwise, LLC does not warrant or make any representations
        ...
        <p>
          ...
          contained on its website at any time without notice. However Pairwise,
          LLC does not make any commitment to update the materials.
        </p>
        <h3>6. Links</h3>
        <p>
          Pairwise, LLC has not reviewed all of the sites linked to its website
          and is not responsible for the contents of any such linked site. The
          inclusion of any link does not imply endorsement by Pairwise, LLC of
          the site. Use of any such linked website is at the user's own risk.
        </p>
        <h3>7. Modifications</h3>
        <p>
          Pairwise, LLC may revise these terms of service for its website at any
        ...
        <p>
          ...
          with the laws of Newark, Delaware and you irrevocably submit to the
