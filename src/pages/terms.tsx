...
const TermsOfService = () => (
  <div>
    ...
    <p>
      ...
      https://prototype-x.netlify.com, you are agreeing to be bound by these
    ...
    <p>
      ...
      Prototype X's Website for personal, non-commercial transitory viewing
    ...
    <ul>
      ...
      <li>
        attempt to reverse engineer any software contained on Prototype X's
        Website;
      </li>
      <li>
    ...
    <p>
      This will let Prototype X to terminate upon violations of any of these
    ...
    <p>
      All the materials on Prototype X’s Website are provided "as is". Prototype
      X makes no warranties, may it be expressed or implied, therefore negates
      all other warranties. Furthermore, Prototype X does not make any
    ...
    <p>
      Prototype X or its suppliers will not be hold accountable for any damages
      that will arise with the use or inability to use the materials on
      Prototype X’s Website, even if Prototype X or an authorize representative
    ...
    <p>
      The materials appearing on Prototype X’s Website may include technical,
      typographical, or photographic errors. Prototype X will not promise that
      any of the materials in this Website are accurate, complete, or current.
      Prototype X may change the materials contained on its Website at any time
      without notice. Prototype X does not make any commitment to update the
      materials.
    </p>
    ...
    <p>
      Prototype X has not reviewed all of the sites linked to its Website and is
      not responsible for the contents of any such linked site. The presence of
      any link does not imply endorsement by Prototype X of the site. The use of
    ...
    <p>
      Prototype X may revise these Terms of Use for its Website at any time
    ...
    <p>
      Please read{' '}
      <a href="https://www.privacypolicygenerator.info/">our Privacy Policy</a>.
    </p>

    <h2>9. Governing Law</h2>

    <p>
      Any claim related to Prototype X's Website shall be governed by the laws
