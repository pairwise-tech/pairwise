      ...
      <ConstrainWidth>
        <div>
          ...
          <p>
            ...
            https://prototype-x.netlify.com, you are agreeing to be bound by
          ...
          <p>
            ...
            materials on Prototype X's Website for personal, non-commercial
          ...
          <ul>
            ...
            <li>
              attempt to reverse engineer any software contained on Prototype
              X's Website;
            </li>
            <li>
          ...
          <p>
            This will let Prototype X to terminate upon violations of any of
          ...
          <p>
            All the materials on Prototype X’s Website are provided "as is".
            Prototype X makes no warranties, may it be expressed or implied,
            therefore negates all other warranties. Furthermore, Prototype X
          ...
          <p>
            Prototype X or its suppliers will not be hold accountable for any
            damages that will arise with the use or inability to use the
            materials on Prototype X’s Website, even if Prototype X or an
          ...
          <p>
            The materials appearing on Prototype X’s Website may include
            technical, typographical, or photographic errors. Prototype X will
            not promise that any of the materials in this Website are accurate,
            complete, or current. Prototype X may change the materials contained
            on its Website at any time without notice. Prototype X does not make
          ...
          <p>
            Prototype X has not reviewed all of the sites linked to its Website
            and is not responsible for the contents of any such linked site. The
            presence of any link does not imply endorsement by Prototype X of
          ...
          <p>
            Prototype X may revise these Terms of Use for its Website at any
          ...
          <p>
            Any claim related to Prototype X's Website shall be governed by the
